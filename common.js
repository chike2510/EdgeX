...
const NAV_ITEMS = [
  ...
  { href:'player-compare.html', icon:'👤', label:'Players',       section:'SPORTS' },
  ...
  { href:'#about',              icon:'ℹ️',  label:'About',         section:'INFO' },
  { href:'#tips',               icon:'💡', label:'Free Tips',     section:'INFO' },
  { href:'#results',            icon:'📊', label:'Results',       section:'INFO' },
  { href:'#community',          icon:'👥', label:'Community',     section:'INFO' },
  { href:'#faq',                icon:'❓', label:'FAQ',           section:'INFO' },
];
  ...
  const pages = {
    about: {
      ...
      html: `
        ...
        <p style="margin-bottom:14px">EdgeX is an AI-powered intelligence platform for Football, Basketball, Crypto, and Forex. It combines Poisson xG models, net rating engines, RSI/MACD signals and live multi-bookmaker odds to surface statistically profitable opportunities.</p>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px">
          ${[['⚽ Poisson xG','Football model'],['🏀 Net Rating','Basketball engine'],['💰 RSI + Bias','Crypto signals'],['📉 Trend','Forex analysis'],['⚖️ Kelly','Stake sizing'],['🔍 EV Calc','Expected value'],['📊 Matrix','Score prediction'],['⚡ APEX','Edge detector']].map(([t,s])=>`
        ...
        <div style="background:rgba(255,200,0,.06);border:1px solid rgba(255,200,0,.2);border-radius:var(--radius);padding:12px;font-size:12px;color:var(--yellow)">
          ⚠️ EdgeX is for research and information only. Signals are model-generated and do not constitute betting or financial advice. Always gamble responsibly.
        </div>`,
    },
    tips: {
      title: 'Free Tips',
