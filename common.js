...
function renderOddsAPIBanner(container, mode, bookmaker = '') {
  ...
  if (mode === 'live') {
    ...
    el.innerHTML = `<div class="oab-dot sim"></div><div class="oab-text">SIMULATION MODE — Add <strong>ODDS_API_KEY</strong> to Vercel env vars for live bookmaker odds</div>`;
  }
}
