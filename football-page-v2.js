...
const TEAMS_DB = [
  ...
  {name:'Man Utd',        league:'EPL',        attack:74,defense:70,form:[0,1,3,0,1],homeAdv:1.10,ppg90:1.2,concede:1.8},
  ...
  {name:'Fulham',         league:'EPL',        attack:72,defense:73,form:[1,3,0,1,1],homeAdv:1.04,ppg90:1.2,concede:1.5},
  {name:'Wolves',         league:'EPL',        attack:68,defense:71,form:[0,0,1,3,1],homeAdv:1.04,ppg90:1.0,concede:1.6},
  {name:'Everton',        league:'EPL',        attack:65,defense:69,form:[1,0,0,1,3],homeAdv:1.05,ppg90:0.9,concede:1.7},
  {name:'Brentford',      league:'EPL',        attack:72,defense:70,form:[3,0,1,3,1],homeAdv:1.04,ppg90:1.2,concede:1.6},
  {name:'Crystal Palace', league:'EPL',        attack:69,defense:72,form:[3,1,0,1,0],homeAdv:1.06,ppg90:1.1,concede:1.5},
  {name:'Leicester',      league:'EPL',        attack:67,defense:66,form:[1,0,1,0,3],homeAdv:1.04,ppg90:1.0,concede:1.7},
  // ── LA LIGA ───────────────────────────────────────────────────────────────
  ...
  {name:'Real Sociedad',  league:'LA LIGA',    attack:76,defense:75,form:[1,3,1,3,1],homeAdv:1.10,ppg90:1.5,concede:1.2},
  {name:'Villarreal',     league:'LA LIGA',    attack:75,defense:74,form:[3,1,0,3,1],homeAdv:1.08,ppg90:1.4,concede:1.3},
  {name:'Athletic Bilbao',league:'LA LIGA',    attack:74,defense:76,form:[3,3,1,0,3],homeAdv:1.12,ppg90:1.5,concede:1.1},
  // ── BUNDESLIGA ────────────────────────────────────────────────────────────
  ...
  {name:'Bayer Leverkusen',league:'BUNDESLIGA',attack:86,defense:80,form:[3,3,3,1,3],homeAdv:1.16,ppg90:2.1,concede:1.0},
  {name:'RB Leipzig',     league:'BUNDESLIGA', attack:81,defense:78,form:[3,1,3,3,1],homeAdv:1.12,ppg90:1.8,concede:1.2},
  // ── SERIE A ───────────────────────────────────────────────────────────────
  ...
  {name:'Napoli',         league:'SERIE A',   attack:80,defense:78,form:[3,3,1,3,0],homeAdv:1.13,ppg90:1.7,concede:1.0},
  {name:'Roma',           league:'SERIE A',   attack:77,defense:74,form:[1,3,3,0,1],homeAdv:1.09,ppg90:1.5,concede:1.3},
  // ── UCL / EUROPE ──────────────────────────────────────────────────────────
  ...
  {name:'Ajax',           league:'UCL',       attack:80,defense:74,form:[3,3,1,3,0],homeAdv:1.14,ppg90:1.8,concede:1.2},
  {name:'Benfica',        league:'UCL',       attack:79,defense:77,form:[3,1,3,3,1],homeAdv:1.13,ppg90:1.7,concede:1.1},
  {name:'Celtic',         league:'UCL',       attack:74,defense:70,form:[3,3,3,1,3],homeAdv:1.15,ppg90:1.8,concede:1.3},
  {name:'Rangers',        league:'UCL',       attack:70,defense:68,form:[1,3,1,3,0],homeAdv:1.11,ppg90:1.5,concede:1.4},
];
...
document.addEventListener('DOMContentLoaded', async () => {
  setupBankroll();
  await Promise.all([loadFixtures(), loadOdds()]);
  renderCalendar();
});
...
async function loadFixtures() {
  try {
    ...
    if (json.success) { ALL_FIXTURES = enrichFixtures(json.data); return; }
  } catch {}
...
async function loadOdds() {
  try {
    ...
    renderOddsAPIBanner('odds-banner', 'simulation');
  }
}
